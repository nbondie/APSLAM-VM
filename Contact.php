...
<div id='contact'>
    <div id='box'>
        <form action="Contact.php" method="post">
            <input class='entrer' type="text" name="to" value="myaddressmail@gmail.com"><br>
            <input class='entrer' type="text" name="subject" placeholder="Subject"><br>
            <textarea class='entrer' name="body"></textarea><br>
            <button id='boutton' type="submit">Envoyer mail</button>
        </form>
    </div>
</div>
...
if(!empty($_POST)) {
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('noe.bondiehouette@sts-sio-caen.info', 'Portfolio');
